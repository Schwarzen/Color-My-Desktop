# Color-My-GNOME
A simple cli tool for creating custom colored gnome-shell and GTK app themes, allowing for easy customization of the system colors and gtk apps on GNOME
